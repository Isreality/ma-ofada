            ...
            {loading ? (
                ...
                <div>
                    ...
                    <div className="lg:hidden">    
                            <button onClick={()=>toggleNavbar(true)} className="">{side ? <MdClose className="bg-disable text-black size-8 absolute p-2 rounded-full top-15 right-20 cursor-pointer"/> : <GiHamburgerMenu className="text-primary font-black absolute top-6 size-5 mr-4 left-4"/>}</button>
                            {side &&(
