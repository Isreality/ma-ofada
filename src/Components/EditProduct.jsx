...
function EditProduct({ productId, show, handleClose }) {
        ...
        const fetchProductDetails = async () => {
            try {
                ...
                if (response.status === 204) {
                    throw new Error('No content returned for this product');
                }
                ...
                if (!response.ok) {
                  ...
                  if (result.status) {
                    ...
                    setFormData({
                        ...
                        numberOfAvailableStocks: result.data.numberOfAvailableStocks || '',
    ...
    }, [show, productId, Atoken, setStatusCode]);
